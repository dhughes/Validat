...
<cfcomponent 
	displayname="Validation Rules Test Suite - Suffix Validator"
	output="false"
	extends="org.cfcunit.framework.TestCase"
	hint="Unit test suite for the Validat Validation Rules - Suffix Validator tests.">
	...
	<cffunction name="setup" access="private" returntype="void"
		...
		<cfset variables.validateNameSuffix = createObject( "component", "validat.validationRules.validateNameSuffix" ) />
	...
	<!--- 
		...
		description:	I will test the validate function, passing in a valid suffix data string.
	--->
	<cffunction name="testValidate_Valid" access="public" returntype="void"
		hint="I will test the validate function, passing in a valid suffix data string." >
	
		<!--- setup temporary variables --->
		<cfset var result = structNew() />

		<!--- call the init method --->
		<cfset variables.validateNameSuffix.init() />
		
		<!--- call the validate method, passing in a valid data string --->
		<cfset result = variables.validateNameSuffix.validate( 'Sr.' ) />
	...
	<!--- 
		...
		description:	I will test the validate function, passing in an invalid suffix data string.
	--->
	<cffunction name="testValidate_Invalid" access="public" returntype="void"
		hint="I will test the validate function, passing in an invalid suffix data string." >
		...
		<!--- call the validate method, passing in an invalid suffix data string --->
		<cfset result = variables.validateNameSuffix.validate( 'John Doe' ) />
	...
	<cffunction name="testValidate_ComplexData" access="public" returntype="void"
		...
		<cftry> <!--- catch the expected error --->
			...
			<cfset result = variables.validateNameSuffix.validate( structNew() ) />
