...
<cfcomponent 
	...
	<!--- 
		function: 		test_validate_Valid_AlphaOnly

		description:	I will test the validate function, passing in a valid data string.
	--->
	<cffunction name="test_validate_Valid_AlphaOnly" access="public" returntype="void"
	...
	</cffunction> <!--- end: test_validate_Valid_AlphaOnly() --->

	<!--- 
		function: 		test_validate_Valid_AlphaNumeric

		description:	I will test the validate function, passing in a valid, alpha numeric data string.
	--->
	<cffunction name="test_validate_Valid_AlphaNumeric" access="public" returntype="void"
	...
	</cffunction> <!--- end: test_validate_Valid_AlphaNumeric() --->
