...
<cfcomponent 
	...
	</cffunction> <!--- end: test_validate_Invalid_String_TooShort() --->
	...
	</cffunction> <!--- end: test_validate_Invalid_Struct_TooShort() --->
	...
	</cffunction> <!--- end: test_validate_Invalid_Array_TooShort() --->
	...
	</cffunction> <!--- end: test_validate_Invalid_Query_TooShort() --->
