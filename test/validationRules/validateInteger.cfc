...
<cfcomponent 
	...
	<!--- 
		function: 		test_validate_Invalid_Float

		description:	I will test the validate function, passing in an invalid float numeric data string.
	--->
	<cffunction name="test_validate_Invalid_Float" access="public" returntype="void"
	...
	</cffunction> <!--- end: test_validate_Invalid_Float() --->
