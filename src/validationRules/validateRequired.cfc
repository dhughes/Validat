...
<cfcomponent
	...
	output="false"
	hint="Required data element validation rule."
	extends="validator">
	
	<!--- ------------------------------------------------------------ --->
	<!--- constructor --->

	<cffunction name="init" access="public" returntype="validateRequired"
	...
	<!--- 
		...
		description:	Check to see if a data value was provided and that it is not an empty/blank string.
	--->
	<cffunction name="validate" access="public" output="false" returntype="boolean"
		hint="Check to see if a data value was provided and that it is not an empty/blank string.">

		<cfargument name="dataValue" type="string" required="false" hint="The data value to be validated" />
		
		<!--- check to see if a data value was provided and that it is not an empty/blank string. --->
		<cfreturn isDefined('arguments.dataValue') AND len(trim(arguments.dataValue)) GT 0 />
